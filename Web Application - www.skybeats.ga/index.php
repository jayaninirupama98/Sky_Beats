...
<div class="wrapper">
  ...
  <div class="content-wrapper  bg-white">
    ...
    <section class="content">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            $title = isset($_GET['page']) ? ucwords(str_replace("_", ' ', $_GET['page'])) : "Home";
             ?>
            <h1 class="m-0 text-gradient-white"><?php echo $title ?></h1>
          </div><!-- /.col -->
      ...
      <div id="audio-player" class="d-flex w-100 justify-content-end align-items-center bg-white py-1 position-absoulute">
            ...
            <audio controls class="bg-white" ended="nextAudioNode.play();" id="mplayer">
        ...
        $.ajax({
          ...
          success:function(resp){
            if(resp){
              ...
              var _html = '<div id="pdet" class="d-flex justify-content-center align-items-center"><img src="assets/uploads/'+resp.cover_image+'" alt="" class="img-thumbnail bg-white" style="width: 50px;height: 50px;object-fit: cover"><div class="ml-2 mr-4"><div><b><large>'+resp.title+'</large></b></div><div><b><small>'+resp.artist+'</small></b></div></div></div>'
  ...
  <footer class="main-footer bg-white">
    <strong>Copyright &copy; 2020 <a href="https://www.skybeats.ga/">Skybeats.ga</a></strong>
    All rights reserved.

<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-white bg-white border-primary">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <?php endif; ?>
      ...
      <li>
        <a class="nav-link text-gradient-white"  href="./index.php?page=home" role="button"> <large><b>Sky Beats Music</b></large></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-flex badge-pill align-items-center bg-gradient-white p-1" style="background: #337cca47 linear-gradient(180deg,#268fff17,#007bff66) repeat-x!important;bprder:50px">

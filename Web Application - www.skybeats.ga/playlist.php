...
<div class="col-lg-12">
	<div class="d-flex justify-content-between align-items-center w-100">
		...
		<button class="btn btn-sm btn-primary bg-white" type="button" id="manage_playlist"><i class="fa fa-plus"></i> Add New Playlist</button>
	</div>
	<div class="row" id="playlist-list">
		...
		?>
		<div class="card bg-white playlist-item my-2 mx-1" date-id="<?php echo $row['id'] ?>" style="width:15vw">
				...
				<?php if($_SESSION['login_type'] == 1 || $_SESSION['login_id'] == $row['user_id'] ): ?>
                	<div class="dropdown position-absolute" style="right:.5em;top:.5em">
	                  ...
	                  <div class="dropdown-menu bg-white">
              			<button class="dropdown-item manage_playlist bg-white" data-id="<?php echo $row['id'] ?>" type="button">Manage List</button>
              			<button class="dropdown-item edit_playlist bg-white" data-id="<?php echo $row['id'] ?>" type="button">Edit</button>
              			<button class="dropdown-item delete_playlist bg-white" data-id="<?php echo $row['id'] ?>" type="button">Delete</button>
	                  </div>
	                  </div>
	              <?php endif; ?>

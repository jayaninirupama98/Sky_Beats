...
<div class="col-lg-12">
	<div class="row">
		<div class="col-md-4">
			<center>
				<div class="d-flex img-thumbnail bg-gradient-1 position-relative" style="width: 12rem">
					...
					<span class="position-absolute" style="bottom:.5em;left:.5em"><div class=" bg-white rounded-circle d-flex justify-content-center align-items-center" style="width: 2rem;height: 2rem;cursor: pointer;" onclick="play_music('assets/uploads/<?php echo $upath ?>')"><i class="fa fa-play"></i></div></span>
				</div>
			</center>
			<div>
			</div>
		...
		<div class="col-md-8">
			...
			<h6 class="text-white border-bottom border-white"><b class="text-white">Description:</b></h6>

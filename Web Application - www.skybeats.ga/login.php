  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				<span  class="m-4 p-2">
  				<h2 class="text-gradient-primary"><b></b></h2>
  			...
  			<div class="card col-sm-7">
  				<div class="card-body">
  					<form id="login-form" >
  						<div class="d-flex justify-content-center align-items-center w-100">
  				<span  class="m-4 p-2">
  					<h1 class="text-gradient-primary text-center" style="font-size: 4rem">  <img src="/images/skybeats1.png" alt="Homepage"></h1>
  				</span>
  			</div>
  						...
  						<center><button class="btn btn-block btn-wave btn-success bg-gradient-primary" type="button" id="new_account">Create New Account</button></center>
  					</form>
  				</div>
  			</div>
  		</div>
